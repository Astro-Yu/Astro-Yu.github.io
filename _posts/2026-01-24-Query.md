...
우리는 프로젝트에서 하나의 기능 실행 시에 54초 라는 믿을 수 없는 숫자를 2ms로 줄여냈다. 그 방법을 공유한다.

방법만 보고 싶다면 바로 [4번](https://astro-yu.github.io/posts/Query/#4-%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8-%EC%BF%BC%EB%A6%AC-%EA%B0%9C%EC%84%A0)으로 이동하라
